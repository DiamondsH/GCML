...
def functional_roberta_for_classification_outputcls(fast_weights=None, config=None, input_ids=None, attention_mask=None, token_type_ids=None,
    ...
    return  cls_output if loss is not None else output

def functional_roberta_for_classification(fast_weights=None, config=None, input_ids=None, attention_mask=None, token_type_ids=None,
                                          position_ids=None, head_mask=None, inputs_embeds=None, encoder_hidden_states=None,
                                          encoder_attention_mask=None, labels=None, is_train=True):
    outputs = functional_roberta(fast_weights, config, input_ids=input_ids, attention_mask=attention_mask,
                                 token_type_ids=token_type_ids,
